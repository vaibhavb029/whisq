<?php 
function testimonial_post_processor_oval( $posts, $testimonial_slider_curr,$out_echo,$set,$data=array() ){
	$skin='oval';
...
function testimonial_slider_get_oval($slider_handle,$r_array,$testimonial_slider_curr,$set,$echo='1',$data=array()){
	$skin='oval';
	global $testimonial_slider,$default_testimonial_slider_settings;
	...
	$responsive_max_width=($testimonial_slider_curr['width']>0)?( $testimonial_slider_curr['width'].'px'  ) : ( '100%' );
		...
		$testimonial_media_queries='.testimonial_slider_set'.$set.'.testimonial_slider{width:100% !important;max-width:'.$responsive_max_width.';display:block;}.testimonial_slider_set'.$set.' .testimonial_slideri *{max-width:'.$testimonial_slider_curr['iwidth'].'px;}.testimonial_slider_set'.$set.' img{max-width:90% !important;}.testimonial_side{width:100% !important;}';
		//filter hook
	...
	$script.='jQuery(document).ready(function() {
			...
			jQuery("head").append("<style type=\"text/css\">#'.$slider_handle.'_nav a.selected{background-position:-'.$testimonial_slider_curr['navimg_w'].'px 0 !important;} .testimonial_slider__oval .testimonial_nav-fillup .inner_nav a { border: 2px solid '.$nav_color.' !important;}.testimonial_slider__oval .testimonial_nav-fillup .inner_nav.selected a:after { background-color: '.$nav_color.' !important; }</style>");
