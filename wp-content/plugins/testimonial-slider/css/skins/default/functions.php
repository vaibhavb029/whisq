<?php 
function testimonial_post_processor_default( $posts, $testimonial_slider_curr,$out_echo,$set,$data=array() ){
	$skin='default';
	...
	if ($testimonial_slider_curr['navnum'] == "1"){ 
		...
		$pagination='pagination  : { container: "#'.$slider_handle.'_nav",
			anchorBuilder: function( nr ) {
				return \'<a href="#" '.$testimonial_slider_css['testimonial_nav_a'].'></a></div>\';
			} },';
    } 
