...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'avant' ) ) ) );
	$standard_fonts = customizer_library_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'avant' ) ) ) );
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'avant' ),
		'cyrillic'     => __( 'Cyrillic', 'avant' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'avant' ),
		'devanagari'   => __( 'Devanagari', 'avant' ),
		'greek'        => __( 'Greek', 'avant' ),
		'greek-ext'    => __( 'Greek Extended', 'avant' ),
		'khmer'        => __( 'Khmer', 'avant' ),
		'latin'        => __( 'Latin', 'avant' ),
		'latin-ext'    => __( 'Latin Extended', 'avant' ),
		'vietnamese'   => __( 'Vietnamese', 'avant' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'avant' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'avant' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'avant' ),
