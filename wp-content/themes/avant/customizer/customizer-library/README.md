...
To see how this works in practice, please see the [Customizer Library Demo](https://github.com/devinsays/customizer-library-avant) theme.
...
$sections[] = array(
	'id' => 'example', // Required
	'title' => __( 'Example Section', 'avant' ), // Required
...
$options['example-panel-text'] = array(
	...
	'label'   => __( 'Example Text Input', 'avant' ),
	'section' => $section,
	'type'    => 'text',
);
~~~
...
$options['example-url'] = array(
	'id' => 'example-url',
	'label'   => __( 'Example URL Input', 'avant' ),
	'section' => $section,
	'type'    => 'url',
);
~~~
...
$options['example-checkbox'] = array(
	'id' => 'example-checkbox',
	'label'   => __( 'Example Checkbox', 'avant' ),
	'section' => $section,
	'type'    => 'checkbox',
	'default' => 0,
);
...
$options['example-dropdown-pages'] = array(
	...
	'label'   => __( 'Example Drop Down Pages', 'avant' ),
	'section' => $section,
	'type'    => 'dropdown-pages',
	'default' => ''
);
...
$options['example-textarea'] = array(
	'id' => 'example-textarea',
	'label'   => __( 'Example Textarea', 'avant' ),
	'section' => $section,
	'type'    => 'textarea',
	'default' => __( 'Example textarea text.', 'avant'),
);
~~~
...
$options['example-range'] = array(
	'id' => 'example-range',
	'label'   => __( 'Example Range Input', 'avant' ),
	'section' => $section,
	'type'    => 'range',
	'input_attrs' => array(
        'min'   => 0,
...
https://github.com/devinsays/customizer-library-avant/blob/master/inc/customizer-options.php
...
function avant_fonts() {
	...
	// Load Google Fonts
	wp_enqueue_style( 'avant_fonts', $font_uri, array(), null, 'screen' );

}
add_action( 'wp_enqueue_scripts', 'avant_fonts' );
~~~
